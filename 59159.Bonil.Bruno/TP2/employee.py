...
class Person:
    ...
    #return ["Claudio", 32]
    def get_person(self):
        person = {'name': self.name, 'surname': self.surname, 'age': self.age, 'num': self.num}
        return person
...
class Employee(Person):
    ...
    def __init__(self, name, surname, age, num, salary):
        # llamamos al metodo init de la clase padre
        Person.__init__(self, name, surname, age, num)
