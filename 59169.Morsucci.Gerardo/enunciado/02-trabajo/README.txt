 ...
 * crear un objeto person y comprobar la funcion get_person la cual devuelve una lista con los datos ingresados
  en person 
 ...
 * crear un objeto employee y comprobar la funcion get_employee la cual devuelve una lista con los datos 
    ingresados en employee 
